...
This is a from-scratch port of the original [FoundryGlance Flutter app](https://github.com/khizardevelops/FoundryGlance) to the **Tauri** desktop framework with a **SvelteKit 5** frontend. Same purpose, same lightweight philosophy — rewritten for a native desktop experience with a fraction of the binary size.
